...
@Entity
@Table(name = "preiseingabeUnternehmen", schema = "fluessiggascrawler", catalog = "")
public class PreiseingabeUnternehmenEntity implements EntityInterface{
    ...
    public PreiseingabeUnternehmenEntity() {
    }

    public PreiseingabeUnternehmenEntity(Integer id,String preis2700Liter, String preis4850Liter, String preis6400Liter,
    ...
    public boolean equals(Object o) {
        ...
        PreiseingabeUnternehmenEntity that = (PreiseingabeUnternehmenEntity) o;
